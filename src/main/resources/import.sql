insert into SCHOOL (school_id, address, fioDirector, accountNumber) values (12,'Parkovaya 1', 'Ivanov P.', '240000005346534');
...
insert into CLASSROOM (className, numberPupil, fioTeacher, school_school_id) values ('2A',32,'Перчаткина М.',45);
insert into CLASSROOM (className, numberPupil, fioTeacher, school_school_id) values ('2A',10,'Ниткина М.',132);
insert into CLASSROOM (className, numberPupil, fioTeacher, school_school_id) values ('3A',20,'Булавкина М.',132);
insert into CLASSROOM (className, numberPupil, fioTeacher, school_school_id) values ('4A',30,'Ручкина М.',132);
